...
class Atri:
	...
	def Portfolio(self, new_state):
		...
		global default_state
		self._Portfolio = Link(new_state, default_state["Portfolio"])
	...
	def Menu5(self, new_state):
		...
		global default_state
		self._Menu5 = Menu(new_state, default_state["Menu5"])
	...
	def Menu8(self, new_state):
		...
		global default_state
		self._Menu8 = Menu(new_state, default_state["Menu8"])
	...
	@property
	def Talks(self):
		self._getter_access_tracker["Talks"] = {}
		return self._Talks
	@Talks.setter
	def Talks(self, new_state):
		self._setter_access_tracker["Talks"] = {}
		global default_state
		self._Talks = TextBox(new_state, default_state["Talks"])
	...
	def Menu9(self, new_state):
		...
		global default_state
		self._Menu9 = Menu(new_state, default_state["Menu9"])
